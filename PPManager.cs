...
namespace PropPainter {
    internal static class PPManager {
        ...
        internal static void Initialize() {
            ...
            UIPanel lineTemplate = UITemplateManager.Get<UIPanel>("LineTemplate");
            if (lineTemplate) {
                UIColorField lineColor = lineTemplate.Find<UIColorField>("LineColor");
                if (lineColor) {
                    UIColorField colorField = Object.Instantiate(lineColor);
                    colorField.isVisible = true;
                    colorField.name = COLORFIELD_NAME;
                    UIColorPicker picker = Object.Instantiate(colorField.colorPicker);
        ...
        internal unsafe static Color GetPropColor(PropInfo info, ref Randomizer randomizer, ushort propID) {
            fixed (Color* color = &m_colors[propID]) {
                if (color->r == 0f && color->g == 0f && color->b == 0f && color->a == FALSEALPHASIG) {
